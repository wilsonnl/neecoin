...
uint256 hashGenesisBlock("0x8f64fe4ba1c22e48eb378d8b136ccd2b5c130eb7da2bfe5d6151938bc6c2aecf");
...
const string strMessageMagic = "NeeCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // NeeCoin: 1 days
static const int64 nTargetSpacing = 120; // NeeCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal neecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NeeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4205675f5e5696cb85becbeb743c7bb0563b54a25175e1e3cd2af7053436dda4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1391772064; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 220701;

        if (fTestNet)
        {
            block.nTime    = 1391738025;
            block.nNonce   = 626217;
        }
